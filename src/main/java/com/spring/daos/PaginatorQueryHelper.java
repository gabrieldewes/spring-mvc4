 ...
 */
class PaginatorQueryHelper {

   PaginatorQueryHelper() {
   }
    ...
    */
    ...
    TypedQuery<Number> countQuery = manager.createQuery(
        "select count(1) from " + klass.getSimpleName() + " o", Number.class);
